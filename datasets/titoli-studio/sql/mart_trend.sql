-- mart_trend — Titoli di studio per comparto: trend multi-anno
--
...
-- Risponde: quanto è cresciuto/diminuito titoli di studio per comparto?
...
select
    ...
    arg_min(tot_dipendenti, anno) as tot_dipendenti_first,
    arg_max(tot_dipendenti, anno) as tot_dipendenti_last,
    arg_max(tot_dipendenti, anno) - arg_min(tot_dipendenti, anno) as delta_tot_dipendenti,
    round(
